...
SELECT İD, AD, YETKİLİSTATU, YETKİLİADSOYAD, YETKİLİTC, SEKTOR, TELEFON1, TELEFON2, TELEFON3, MAİL, FAX, İL, İLÇE, VERGİDAİRESİ, ADRESS, OZELKOD1, OZELKOD2, OZELKOD3 FROM firmalar WHERE (İD = @İD)";
        ...
        public virtual int Fill(TicariOtomasyonDataSet.firmalarDataTable dataTable) {
        ...
        public virtual TicariOtomasyonDataSet.firmalarDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TicariOtomasyonDataSet.firmalarDataTable dataTable = new TicariOtomasyonDataSet.firmalarDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TicariOtomasyonDataSet.firmalarDataTable dataTable) {
